...
public class MyActivity extends Activity {
    ...
    View.OnClickListener startChrono = new View.OnClickListener() {
    ...
    View.OnClickListener stopChrono = new View.OnClickListener() {
    ...
    View.OnClickListener lapTime = new View.OnClickListener() {
